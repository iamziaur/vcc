...
export const TRANSLATIONS: Translation = {
  ...
  map_usage_tip: { 
    bn: 'আপনার প্রয়োজনীয় কেন্দ্রগুলো আসন 1,2,3 থেকে খুঁজুন। পছন্দ হলে ⭐ Favorite বাটনে ক্লিক করে হোমে যোগ করুন। এরপর [আমার সেন্টার] হোম পেজে থেকেই আপনার ⭐প্রিয় তালিকায় যোগ করা থানা বা ইউনিয়নের নাম দেখতে পাবেন। নামের উপর ক্লিক করলে আপনি সরাসরি গুগল ম্যাপে চলে যাবেন এবং আপনার কাঙ্ক্ষিত সেবা পেতে পারবেন।\n\n📌 ম্যাপ ব্যবহার নির্দেশনা\nম্যাপের লিংক ওপেন করার পর উপরের বাম কোণের মেনু বাটন [ ◧ ] এ ক্লিক করে আপনার কাঙ্ক্ষিত ইউনিয়ন বা সেন্টারটি নির্বাচন করুন। (বিশেষ করে চাঁপাইনবাবগঞ্জ-২ আসনের থানাগুলোর ক্ষেত্রে এটি ব্যবহার করা আবশ্যক)।', 
    en: 'Find your required centers from Seat 1, 2, or 3. Click the ⭐ Favorite button to add them to home. Then go to the [My Center] option to see your favorited Thana or Union names. Clicking the name will take you directly to Google Maps.\n\n📌 Map Usage Instructions\nAfter opening the map link, click the menu button [ ◧ ] on the top left to select your desired union or center (especially mandatory for Seat-2 Thanas).' 
  },
